...
export function ParsePipeline({ tokens, prompt, parsed, ranked, goalWeights, isMultiGoal, ai }: {
  tokens: ThemeTokens; prompt: string; parsed: ParsedData; ranked: { verdict: string; structure: string }[]; goalWeights: Record<string, number>; isMultiGoal: boolean; ai: AiData
}) {
...
export function BestMatch({ tokens, best, top3 }: { tokens: ThemeTokens; best: { recipe: LayoutRecipe; score: number; structure: string }; top3: { structure: string; recipe: LayoutRecipe; score: number }[] }) {
