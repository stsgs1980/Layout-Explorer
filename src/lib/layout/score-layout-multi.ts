/**
 * Multi-goal layout scoring — weighted combination across multiple goals.
 * Extracted from score-layout.ts for anti-monolith compliance.
 */

import type {
  LayoutRecipe, LayoutAdviceInput, LayoutRecommendation,
} from './types'
import { WEIGHTS, scoreLayout } from './score-layout'
